(function(root){var breaker={},AP=Array.prototype,OP=Object.prototype,hasOwn=OP.hasOwnProperty,toString=OP.toString,forEach=AP.forEach,indexOf=AP.indexOf,slice=AP.slice;var _each=function(obj,iterator,context){var key,i,l;if(!obj){return;}
...
return deferred.promise();};if(typeof module!=="undefined"&&module.exports){module.exports=_d;}else if(typeof root._!=="undefined"){root._.mixin(_d);}else{root._=_d;}})(this);