        ...
        sub vcl_recv {
          ...
          if (!req.method ~ "BAN|GET|HEAD|PUT|POST|TRACE|OPTIONS|DELETE") {
          ...
          if (req.url ~ "\.(jpeg|jpg|png|gif|ico|swf|js|css|txt|eot|woff|woff2|ttf|htc)(\?.*|)$") {
          ...
          # Remueve parametros de campaña de la url
          if (req.url ~ "(\?|&)(fbclid|utm_[a-z]+)=") {
        ...
        #Enmascara el Error de Varnsih
        sub vcl_backend_error {
             if (beresp.status == 503) {
                set beresp.http.Location = "https://saturado.buenosaires.gob.ar";
